...
export default function OnboardingScreen1() {
  ...
  return (
    <View className="bg-blue-600 flex-1 justify-center items-center p-6">
      <Text className="text-white text-3xl font-bold">Welcome to Video Watch Timer</Text>
      <Text className="text-white text-lg mt-3 text-center">Track your video engagement with ease.</Text>

      {permissionsGranted && (
        <TouchableOpacity onPress={() => router.push('/onboarding/screen2')} className="mt-6 bg-white px-6 py-3 rounded-lg">
